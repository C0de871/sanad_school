                ...
                children: [
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                              color: context.read<QuizSelectionCubit>().quizScreenArgs.subjectColor,
                            ),
                          ),
                        ],
                      ),
                  ...
                  SliderTheme(
                    data: SliderThemeData(
                      activeTrackColor: context.read<QuizSelectionCubit>().quizScreenArgs.subjectColor,
                      inactiveTrackColor: context.read<QuizSelectionCubit>().quizScreenArgs.subjectColor.withOpacity(0.3),
                      thumbColor: context.read<QuizSelectionCubit>().quizScreenArgs.subjectColor,
                      overlayColor: context.read<QuizSelectionCubit>().quizScreenArgs.subjectColor.withOpacity(0.2),
